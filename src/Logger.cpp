...
namespace MyGimp {
    ...
    void Logger::initialize() {
        ...
        std::cout << "[" << getCurrentTimestamp() << "] [MyGimp] [INFO] Logger initialized with console fallback" << std::endl;
#endif
    ...
    void Logger::shutdown() {
        ...
        if (logger) {
            ...
            std::cout << "[" << getCurrentTimestamp() << "] [MyGimp] [INFO] Logger shutting down" << std::endl;
        }
#else
        std::cout << "[" << getCurrentTimestamp() << "] [MyGimp] [INFO] Logger shutting down" << std::endl;
#endif
